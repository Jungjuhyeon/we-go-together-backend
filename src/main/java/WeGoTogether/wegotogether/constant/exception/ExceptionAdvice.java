...
public class ExceptionAdvice extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity onThrowException(CustomException customException, HttpServletRequest request) {
        ErrorReasonDTO errorReasonHttpStatus = customException.getErrorReasonHttpStatus();
...
//        e.printStackTrace();
    ...
    private ResponseEntity<Object> handleExceptionInternalArgs(Exception e, HttpHeaders headers, ErrorStatus errorCommonStatus,
                                                               WebRequest request, String errorArgs) {
        ApiResponse<Object> body = ApiResponse.onFailure(errorCommonStatus.getCode(),errorArgs,null);
        return super.handleExceptionInternal(
                e,
                body,
                headers,
